...
extern int __pyx_module_is_main__pulla_cy;
...
static PyObject *__pyx_kp_s_pulla_pyx;
...
static PyMethodDef __pyx_mdef_9_pulla_cy_1pulla = {"pulla", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9_pulla_cy_1pulla, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9_pulla_cy_1pulla(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("pulla (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_astep)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_Eistep)) != 0)) kw_args--;
        else {
        ...
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ptmpco)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("pulla", 1, 8, 8, 3); __PYX_ERR(0, 9, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_aeq)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("pulla", 1, 8, 8, 4); __PYX_ERR(0, 9, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_me)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("pulla", 1, 8, 8, 5); __PYX_ERR(0, 9, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_sigT)) != 0)) kw_args--;
        else {
...
static int __pyx_pymod_exec__pulla_cy(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__pulla_cy},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_pulla_pyx, __pyx_k_pulla_pyx, sizeof(__pyx_k_pulla_pyx), 0, 0, 1, 0},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_pulla_cy(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_pulla_cy(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__pulla_cy(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__pulla_cy(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__pulla_cy(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_pulla_cy' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__pulla_cy(void)", 0);
